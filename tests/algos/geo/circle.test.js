...
describe("Circle Algo():", () => {
  test("distace algorithm to be accessible with callback", async () => {
    expect.assertions(2);
  ...
  test("distace algorithm to be accessible without callback", async () => {
    expect.assertions(1);
